...
public interface EveManageClientFacade {
    ...
    Map<Long, String> fetchPricesFromEveMetricsForTypeIDs(List<Long> typeIDs) throws EveMetricsApiException;
    ...
    void createApiKey(Long apiKeyUserID, String apiKeyString) throws EveApiException, ApiKeyNotValidException;
