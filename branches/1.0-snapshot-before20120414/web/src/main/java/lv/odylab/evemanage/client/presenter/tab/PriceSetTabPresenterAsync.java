...
public class PriceSetTabPresenterAsync implements Presenter {
    private static PriceSetTabPresenter instance = null;
    ...
    @Inject
    public PriceSetTabPresenterAsync(EveManageGinjector ginjector, EventBus eventBus, TrackingManager trackingManager, EveManageConstants constants) {
    ...
    public void go(final HasWidgets container) {
        GWT.runAsync(new RunAsyncCallback() {
            ...
            public void onSuccess() {
                if (instance == null) {
                    instance = ginjector.getPriceSetTabPresenter();
                }
