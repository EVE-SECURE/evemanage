...
public class EveNumberFormat {
    ...
    public static final NumberFormat QUANTITY_APPROX_FORMAT = NumberFormat.getFormat("###,###,###,###,###,###,##0.00");
    ...
    public static final NumberFormat MULTIPLIER_FORMAT = NumberFormat.getFormat("#0.00");
}
