...
public class PriceSetDeleteActionResponse implements Response {
    ...
    public String getDeletedPriceSetName() {
        return deletedPriceSetName;
    }

    public void setDeletedPriceSetName(String deletedPriceSetName) {
        this.deletedPriceSetName = deletedPriceSetName;
    }
}